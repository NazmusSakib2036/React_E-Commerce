...
const Product = () => {
  ...
  useEffect(() => {
    if (location.state?.fromProducts) {
      ...
      const similarProductsData = location.state.similarProducts;
      ...
      <div className="container my-5 py-2">
        <div className="row">
          ...
          <div className="col-md-6 py-5">
            ...
            <p className="lead">
              {product.rating?.rate || "N/A"} <i className="fa fa-star"></i>
            </p>
        ...
        <div className="row my-5 py-5">
          <div className="d-none d-md-block">
            ...
            <Marquee pauseOnHover pauseOnClick speed={50}>
              {similarProducts.length > 0 ? <ShowSimilarProduct /> : <Loading2 />}
            </Marquee>
          </div>
        </div>
      </div>
